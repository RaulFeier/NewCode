...
int main() {
  ...
  while (tc--) {
    ...
    auto beep1 = ans.find(eep1);
    auto beep2 = ans.find(eep2);
    auto beep3 = ans.find(eep3);
    auto beep4 = ans.find(eep4);

    if (beep1 != string::npos) {
      beep.pb(ans.size() - 2);
    }
    if (beep2 != string::npos) {
      beep.pb(ans.size() - 2);
    }
    if (beep3 != string::npos) {
      beep.pb(ans.size() - 1);
    }
    if (beep4 != string::npos) {
      beep.pb(ans.size() - 3);
    }
