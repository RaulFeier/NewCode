...
class SettingsPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        choices_size = ["Board size: Small", "Board size: Normal"]
        ...
        choices_difficulty = ["Difficulty: Easy", "Difficulty: Normal"]
...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller, gui):
        ...
        button1 = tk.Button(self, text="New Game", font=40,
                            ...
                            bg=color_bg, activebackground=color_active)
        button1.place(relx=0.4, rely=0.43, relheight=0.15, relwidth=0.2)
        button3 = tk.Button(self, text="Settings", font=40,
                            command=lambda: controller.show_frame("SettingsPage"),
                            bg=color_bg, activebackground=color_active)
        button3.place(relx=0.4, rely=0.63, relheight=0.15, relwidth=0.2)
