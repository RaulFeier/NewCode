...
int main() {
  ...
  while (tc--) {
    ...
    if ((ans[0] == 'm' or ans[0] == 'M') and n >= 4) {
      bool search_e = true;
      bool search_o = false;
      bool search_w = false;
      bool search_other = false;
      for (i64 i : range(ans.size())) {
        if (search_e) {
          if (ans[i] == 'e' or ans[i] == 'E') {
            search_o = true;
            search_e = false;
            found_e = true;
    ...
    if (eep or !found_e or !found_o or !found_w) {
      cout << "NO" << endl;
    } else {
      cout << "YES" << endl;
    }
