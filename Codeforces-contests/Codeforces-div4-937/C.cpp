  ...
  while (tc--) {
    ...
    if (hour >= 0 and hour < 12) {
      if (hour < 10) {
        if (hour == 0) {
          if (ok) {
            cout << 12 << ':' << 0 << minute << " AM" << endl;
          } else {
            cout << 12 << ':' << minute << " AM" << endl;
          }
        } else {
          if (ok) {
            cout << 0 << hour << ':' << 0 << minute << " AM" << endl;
          } else {
            cout << 0 << hour << ':' << minute << " AM" << endl;
          }
        }
      } else {
        if (ok) {
          cout << hour << ':' << 0 << minute << " AM" << endl;
      ...
      if (hour < 10) {
        if (hour == 0) {
          if (ok) {
            cout << 12 << ':' << 0 << minute << " PM" << endl;
          } else {
            cout << 12 << ':' << minute << " PM" << endl;
          }
        } else {
          if (ok) {
            cout << 0 << hour << ':' << 0 << minute << " PM" << endl;
          } else {
            cout << 0 << hour << ':' << minute << " PM" << endl;
          }
        }
      } else {
        if (ok) {
          cout << hour << ':' << 0 << minute << " PM" << endl;
