...
bool condition(i64 l, i64 r, i64 a, i64 b) {
  if (l <= a + b and a + b <= r and gcd(a, b) != 1 and a != 0 and b != 0) {
    return true;
  }
  return false;
}
...
int main() {
  ...
  while (tc--) {
    ...
    if (l % 2 == 0 and r >= l + 2) {
      cout << l << " " << 2 << endl;
    } else if (l % 2 == 0 and l > 3) {
      cout << l - 2 << " " << 2 << endl;
    } else if (l % 2 == 1 and l > 2 and r >= l + 1) {
      cout << l - 1 << " " << 2 << endl;
    } else if (l % 2 == 1 and l <= 2 and r >= 2 + 2) {
      cout << 2 << " " << 2 << endl;
    } else if (l == r and l >= 4) {
      if (l % 2 == 0) {
        cout << l / 2 << " " << l / 2 << endl;
        ...
        bool found = false;
        for (int i = 1; i * i <= l; i++) {
          if (condition(l, r, i, l - i)) {
            cout << i << " " << l - i << endl;
            found = true;
            break;
          }
          if (l % i == 0 and condition(l, r, l / i, l - l / i)) {
            cout << l / i << " " << l - l / i << endl;
            found = true;
            break;
          }
