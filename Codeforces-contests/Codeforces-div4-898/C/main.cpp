      ...
      for (i64 j : range(10)) {
        if (a[i][j] == 'X') {
          if ((i == 4 or i == 5) and (j == 4 or j == 5)) {
            total += 5;
          } else if ((i == 3 or i == 4 or i == 5 or i == 6) and
                     (j == 3 or j == 4 or j == 5 or j == 6)) {
            total += 4;
          } else if ((i == 2 or i == 3 or i == 4 or i == 5 or i == 6 or
                      i == 7) and
                     (j == 2 or j == 3 or j == 4 or j == 5 or j == 6 or
                      j == 7)) {
            total += 3;
          } else if ((i == 1 or i == 2 or i == 3 or i == 4 or i == 5 or
                      i == 6 or i == 7 or i == 8) and
                     (j == 2 or j == 3 or j == 4 or j == 5 or j == 6 or
                      j == 7 or j == 1 or j == 8)) {
            total += 2;
          } else {
