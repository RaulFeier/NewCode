...
int main()
{
    ...
    if ((v[0][0] + v[1][1] + v[2][0] + v[1][0]) % 2 == 0)
    {
        v1[1][0] = 1;
    }
    else
    ...
    if ((v[1][1] + v[1][0] + v[1][2] + v[2][1] + v[0][1]) % 2 == 0)
    {
        v1[1][1] = 1;
    }
    else
    ...
    if ((v[0][2] + v[1][2] + v[1][1] + v[2][2]) % 2 == 0)
    {
        v1[1][2] = 1;
    }
    else
    ...
    if ((v[2][1] + v[2][0] + v[2][2] + v[1][1]) % 2 == 0)
    {
        v1[2][1] = 1;
    }
    else
