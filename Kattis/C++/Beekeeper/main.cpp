...
int main()
{
    ...
    while (true)
    {
        ...
        for (i64 i = 0; i < n; i++)
        {
            ...
            {
                if (ans[j] == 'e' && ans[j + 1] == 'e' && j != ans.size() - 1)
                {
                    t++;
                    j++;
                }
                else if (ans[j] == 'a' && ans[j + 1] == 'a' && j != ans.size() - 1)
                {
                    t++;
                    j++;
                }
                else if (ans[j] == 'i' && ans[j + 1] == 'i' && j != ans.size() - 1)
                {
                    t++;
                    j++;
                }
                else if (ans[j] == 'o' && ans[j + 1] == 'o' && j != ans.size() - 1)
                {
                    t++;
                    j++;
                }
                else if (ans[j] == 'u' && ans[j + 1] == 'u' && j != ans.size() - 1)
                {
                    t++;
                    j++;
                }
                else if (ans[j] == 'y' && ans[j + 1] == 'y' && j != ans.size() - 1)
                {
                    t++;
                    j++;
                }
