...
i64 solve1(vec<vec<char>> &v, i64 n) {
  int t = 0;
  for (i64 i : range(n)) {
    i64 w = 0, b = 0;
    for (i64 j : range(n)) {
...
i64 solve2(vec<vec<char>> &v, i64 n) {
  int t = 0;
  for (i64 i : range(n)) {
    i64 w = 0, b = 0;
    for (i64 j : range(n)) {
...
bool solve3(vec<vec<char>> &v, i64 n) {
  for (i64 i : range(n)) {
    for (i64 j : range(n)) {
      if (j < n - 3) {
        if (v[i][j] == 'W' && v[i][j + 1] == 'W' && v[i][j + 2] == 'W') {
          return false;
        } else if (v[i][j] == 'B' && v[i][j + 1] == 'B' && v[i][j + 2] == 'B') {
          return false;
        }
      }
    }
  ...
  for (i64 i : range(n)) {
    for (i64 j : range(n)) {
      if (j < n - 3) {
        if (v[j][i] == 'W' && v[j + 1][i] == 'W' && v[j + 2][i] == 'W') {
          return false;
        } else if (v[j][i] == 'B' && v[j + 1][i] == 'B' && v[j + 2][i] == 'B') {
          return false;
        }
      }
    }
